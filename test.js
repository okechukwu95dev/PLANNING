...
.platform-data-default-route .cards-container { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 280px)); justify-content: center; gap: 20px; margin-top: 40px; }
...
@media (min-width: 1200px) { .platform-data-default-route .cards-container { gap: 40px; } }
